...
# 3. Запустите приложение (с автозапуском БД)
run.bat
```

> **Примечание:** Приложение автоматически запускает PostgreSQL при подключении. Если PostgreSQL не найден, следуйте инструкциям на экране.
